(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Monsoon-https://monsoonmalabar.com/monsoonmalabar-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		sendEmail: function() {
			if( this.$checkoutCart.length && this.$userDetails.length ) {
				...
				if( items.length == 0 ) {
					...
					var uemail = 'monsoontest1@gmail.com';
